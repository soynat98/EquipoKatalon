...
public class TestCase {
  ...
  public void testTestCase() throws Exception {
	    ...
	    driver.findElement(By.name("name")).sendKeys("natalia");
	    driver.findElement(By.name("email")).click();
	    driver.findElement(By.name("email")).clear();
	    driver.findElement(By.name("email")).sendKeys("natalia@admsoftware.com");
	    ...
	    driver.findElement(By.name("name")).click();
	    driver.findElement(By.name("name")).clear();
	    driver.findElement(By.name("name")).sendKeys("Cristina");
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Woah!'])[1]/following::button[1]")).click();
	    driver.findElement(By.xpath("//i")).click();
	    driver.findElement(By.xpath("//div[@id='root']/div/div[2]/table/tbody/tr/td")).click();
	    try {
	      assertEquals(driver.findElement(By.xpath("//div[@id='root']/div/div[2]/table/tbody/tr/td")).getText(), "Cristina");
	    } catch (Error e) {
